...
func DashboardRegister(group *gin.RouterGroup) {
	...
	group.GET("/flwo_stat", service.FlowStat)
...
// @Description 指标统计
// @Tags 首页大盘
// @ID /dashboard/panelGroupDate
// @Accept  json
// @Produce  json
// @Success 200 {object} middleware.Response{data=dto.PanelGroupDataOutput} "success"
// @Router /dashboard/panelGroupDate [get]
func (service *DashboardController) PanelGroupDate(c *gin.Context) {
	serviceInfo:=&dao.ServiceInfo{}
	_,servicenum,err:=serviceInfo.PageList(c,lib.GORMDefaultPool,&dto.ServiceListInput{
		PageNo:   1,
		PageSize: 1,
	})
	if err != nil {
	...
	app:=&dao.App{}
	_,appnumber,err:=app.APPList(c,lib.GORMDefaultPool,&dto.APPListInput{
